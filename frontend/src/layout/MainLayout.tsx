    ...
    <>
              ...
              <Sidebar collapsed={selector.collapsed} breakPoint="lg" toggled={selector.toggle} >
                  <Menu >
                      ...
                      <MenuItem component={<Link to="/" />} icon={<MdOutlineSpaceDashboard  className="text-2xl" />} >Sales Analytic </MenuItem>
        
            <MenuItem component={<Link to="/orders" />} icon={<FiBox className="text-2xl" />}> Orders </MenuItem>

            <MenuItem component={<Link to="/user" />} icon={<FiUser className="text-2xl" />} > Customers </MenuItem>
            <MenuItem component={<Link to="/inventory" />} icon={<FiUser className="text-2xl" />} > Inventory </MenuItem>
                  </Menu>
              </Sidebar>
